                       ...
                       <ul class="header__category-list">
                           <li class="header__category-list-item item-has-submenu">
                               <a href="{{url('/category-product')}}"class="header__category-list-item-link">
                                   <img src="{{ asset('frontend/assets/images/product.png') }}">
                                   Test Category
                               </a>
               ...
               <div class="product-items-wrapper">
                   <div class="product__item-outer">
                       <div class="product__item-image-outer">
                           <a href="{{url('/details')}}" class="product__item-image-inner">
                               <img src="{{ asset('frontend/assets/images/product.png') }}" alt="Product Image" />
                           </a>
                           <div class="product__item-add-cart-btn-outer">
                               <a href="{{url('/details')}}" class="product__item-add-cart-btn-inner">
                                   Add to Cart
                               </a>
                           </div>
